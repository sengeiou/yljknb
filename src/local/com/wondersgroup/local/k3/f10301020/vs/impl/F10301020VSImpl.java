package com.wondersgroup.local.k3.f10301020.vs.impl;
...
import com.wondersgroup.bc.k3.f10301020.bs.F10301020BS;
...
public class F10301020VSImpl implements F10301020VS{
	
	private F10301020BS f10301020bs;
	
	public F10301020BS getF10301020bs() {
		return f10301020bs;
	}

	public void setF10301020bs(F10301020BS f10301020bs) {
		this.f10301020bs = f10301020bs;
	}
	...
	public List<QueryApprovalVo> queryData(QueryApprovalVo approvalVo) {
		...
		return this.getF10301020bs().queryApprovalData(approvalVo);
	}
	...
	public QueryApprovalVo operateApproval(QueryApprovalVo approvalVo) {
		...
		ApprovalClassList acl = this.getF10301020bs().qryMaxApprovalId();
		if (approvalVo.getAclid().equals( acl.getAclid())) {
			Af31DTO af31Dto = this.getF10301020bs().getAf31ByAaz077(approvalVo.getAaz077());
			String apa011 = null;
			...
			if (AuditConstants.APA011_CODE_1.equals(apa011)) {
				...
				Af53DTO af53Dto = this.getF10301020bs().getAf53ByAaz318(aaz318);
				af53Dto.setAae426(AuditConstants.AAE426_CODE_10);
				this.getF10301020bs().updateAf53(af53Dto);
			}else if (AuditConstants.APA011_CODE_0.equals(apa011)) {
				
				String aaz318 = String.valueOf(approvalVo.getAaz318());
				
				List<Af31> af31s = this.getF10301020bs().getAf31ById(aaz318);
		...
		return this.getF10301020bs().operateApproval(approvalVo);
	}
	
	public void jumpOut(String aaz318) {
		this.getF10301020bs().jumpOut(aaz318);
