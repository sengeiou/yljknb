...
public class SetPriorityAction extends BaseAjaxAction{
	...
	protected String operate() {
		...
		this.f10401002VS.savePriority(this.getServletRequest().getParameter("aaz333"), this.getServletRequest().getParameter("ake070"));
