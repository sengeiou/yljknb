 ...
 * @since 1.0
 */
public class CommonHibernateDaoUtils {

	public CommonHibernateDaoUtils(CommonHibernateDao commonHibernateDao) {
		CommonHibernateDaoUtils.commonHibernateDao = commonHibernateDao;
	}
