package com.wondersgroup.bc.k2.f10205001.bs.impl;
...
import com.wondersgroup.bc.medicarecostaudit.medaudit.model.dto.BaseDbz;
...
public class F10205001BSImpl implements F10205001BS {
	...
	public Page queryKc65WithPage(Page page, Kc65DTO queryDto) {
		StringBuffer sql = new StringBuffer(
				" select a.* from kc65 a  where 1 = 1 and a.baz031='12' ");
	...
	public Kc65DTO updateKc65(Kc65DTO kc65Dto) {
		...
		BaseDbz dbz=new BaseDbz(kc65.getAaz217());
		
		CommonHibernateDaoUtils.executeStoreProcedure("YLJK_DBZ_CLCF", dbz);
