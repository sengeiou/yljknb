package com.wondersgroup.bc.k5.f10504003.bs.impl;
...
public class F10504003BSImpl implements F10504003BS{
	...
	public Page queryKc63WithPage(Page page, Kc63DTO kc63Dto) {
		...
		// 添加条件
		sql.append("  and a.baz001 = b.baz001 and b.baz031='04' and (b.baz101='1'  or  b.baz101='3') ");
	...
	public Page queryKc62WithPage(Page page, Kc62DTO kc62Dto) {
		...
		sql.append(" and (t2.baz031='04' and (t2.baz101='1'  or  t2.baz101='3'))");
	...
	public List<QueryNumberVO> getQueryNumberVO(String akb020orakb021) {
		...
		//待申诉处理
		sql.append(" select a.akb020, a.akb021, count(distinct b.baz001) dsscl from kc63 a, kc62 b where a.baz001 = b.baz001 and b.baz031 = '04' and b.baz101 = '1' group by a.akb020, a.akb021) k1");
		//待申诉审核
		sql.append(" full outer join (select a.akb020, a.akb021, count(distinct b.baz001) dsssh from kc63 a, kc62 b where a.baz001 = b.baz001 and b.baz031 = '04' and b.baz101 = '3' group by a.akb020, a.akb021) k2");
		sql.append(" on k1.akb020 = k2.akb020");
		//超期数
		sql.append(" full outer join (select a.akb020, a.akb021, count(distinct b.baz001) cq from kc63 a, kc62 b where a.baz001 = b.baz001 and b.baz031 = '04' and b.baz101 = '1' group by a.akb020, a.akb021) k3");
		sql.append(" on k1.akb020 = k3.akb020)k");
		//直接扣款
...
//		sql.append(" on k1.akb020 = k6.akb020) k");
		...
		if(StringTools.hasText(akb020orakb021)){
			sql.append(" and trim(k.yybh) = '"+akb020orakb021.trim()+"' or k.yymc like '%"+ akb020orakb021.trim()+"%'");
		}
		
		//按参数值降序显示
		sql.append(" order by dssshs desc,dsscls desc,cqs desc");
		
		List<QueryNumberVO> queryNumberVOList  = CommonJdbcDaoUtils.query(sql.toString(), QueryNumberVO.class);
