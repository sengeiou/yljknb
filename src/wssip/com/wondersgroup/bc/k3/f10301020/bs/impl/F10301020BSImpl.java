package com.wondersgroup.bc.k3.f10301020.bs.impl;
...
public class F10301020BSImpl implements F10301020BS{
	...
	public void jumpOut(String aaz318) {
		...
		StringBuffer sql = new StringBuffer("update af53 a set a.aae426 = 10 where a.aaz318 = '" + aaz318 + "'");
