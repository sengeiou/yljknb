package com.wondersgroup.bc.k3.f10301019.bs.impl;
...
public class F10301019BSImpl implements F10301019BS{
	...
	public List<QueryApprovalVo> queryApproalData(String aaz318) {
		...
		sql.append(" and a.aclid in (1, 2, 3) ");
		...
		/*for (QueryApprovalVo queryApprovalVo : list) {
			if (2 == queryApprovalVo.getAclid() && "未审批".equals(queryApprovalVo.getAilzt())) {
				throw new BusinessException("二级未审批");
			}
		}*/
