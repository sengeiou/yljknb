package com.wondersgroup.bc.k3.f10301023.bs.impl;
...
public class F10301023BSImpl implements F10301023BS{
	...
	public List<QueryApprovalVo> queryApproalData(String aaz318) {
		...
		if (!StringTools.hasText(aaz318)) {
			...
			throw new BusinessException("F10301023BSImpl-01: aaz318 is null");
