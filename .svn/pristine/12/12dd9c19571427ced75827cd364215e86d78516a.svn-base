...
public class Ac01DTO extends Ac01 {
    ...
    private Date aac049s;
    
    private String aac005;//年龄
    
    private String apa065;//人员类别
    
    private String ape029; //工作单位
	...
	public String getApa065() {
		return apa065;
	}

	public void setApa065(String apa065) {
		this.apa065 = apa065;
	}

	public String getApe029() {
		return ape029;
	}

	public void setApe029(String ape029) {
		this.ape029 = ape029;
	}
	...
	public Date getAac049s() {
		return aac049s;
	}

	public void setAac049s(Date aac049s) {
		this.aac049s = aac049s;
	}
}
