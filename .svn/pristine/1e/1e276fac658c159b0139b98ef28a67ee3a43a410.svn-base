 ...
 */
@MappedSuperclass
public abstract class BaseKe12 {

	private Long aaz344;//医师治疗情况分析ID
    ...
    private String aac003;//医护人员姓名
    private String aab014;//医师公民身份号码
    
    @Id 
    @GeneratedValue(strategy = GenerationType.SEQUENCE,generator="SEQUENCE")
    @SequenceGenerator(name="SEQUENCE", sequenceName="SEQ_AAZ344", allocationSize = 1) 
    @Column(name="AAZ344", unique=true, nullable=false, precision=16, scale=0)
    public Long getAaz344() {
         return this.aaz344;
    }
       
    public void setAaz344(Long aaz344) {
           this.aaz344 = aaz344;
    }
