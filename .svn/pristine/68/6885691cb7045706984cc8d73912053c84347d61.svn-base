...
<body>
						...
						<div id="sp2" class="mini-splitter"
							...
							<div size="50%" showCollapseButton="false">
								...
								<div id="datagrid1" class="mini-datagrid"
									...
									url="${pageContext.request.contextPath}/k2/f10203003/queryMedDocument.action">
							...
							<div size="50%" showCollapseButton="false">
								...
								<div id="datagrid2" class="mini-datagrid" style="height: 86%;"
									...
									showColumnsMenu="true"
									url="${pageContext.request.contextPath}/k2/f10203003/queryMedDocumentDetail.action">
									<div property="columns">
										<div type="checkcolumn"></div>
										<div type="expandcolumn">~</div>
										<div field="baz031" type="comboboxcolumn" width="100"
	...
	<script type="text/javascript">
		...
		function showDetailHos(){
			...
			$
					.ajax({
						url : "${pageContext.request.contextPath}/k2/f10203003/queryMedDocumentByHos.action",
						type : "post",
						data : {query:akb020orakb021},
						success : function(text) {
							if (text.success) {
								$("#menuList1").empty();
								for ( var i = 0; i < text.result.length; i++) {
									...
									htmlStr+= "<a class='top_name_fontsize' href='#' onclick=setandsearch('"+text.result[i].akb021+"','"+text.result[i].akb020.trim()+"')>"+ text.result[i].akb021+"</a>";
									htmlStr +="</div>";
								...
								/* 	htmlStr+="<td style='padding-bottom:6px;'>直接扣款数："+text.result[i].zjkks+"</td>"; */
									...
									htmlStr+="<td style='padding-bottom:6px;'><div class='td_number'>"+text.result[i].drgcs+"</div>	</td>";
									htmlStr+="<td style='padding-bottom:6px;'><div class='td_number'>"+text.result[i].dsssh+"</div>	</td>";
									htmlStr+="</tr>";
