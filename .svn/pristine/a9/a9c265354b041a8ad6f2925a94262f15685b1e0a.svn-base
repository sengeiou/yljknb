	...
	<body>
						...
						<table class="cxTab" cellpadding="0" cellspacing="0" border="0" width="100%">
										...
										<div class="inputR">
											<div class="inputC">
												<input id="aae140" name="aae140" class="mini-combobox"
													emptyText="请选择..." data="${dic['AAE140']}" textField="text" valueField="id" required="true" />
											</div>
										</div>
									</div>
								</td>
										...
										<div class="inputR">
											<div class="inputC">
												<input id="akb022" name="akb022" class="mini-combobox"
													emptyText="请选择..." data="${dic['AKB022']}" textField="text" valueField="id" required="true" />
											</div>
										</div>
									</div>
								</td>
										...
										<div class="inputR">
											<div class="inputC">
												<input id="aka063" name="aka063" class="mini-combobox"
													emptyText="请选择..." data="${dic['AKA063']}" textField="text" valueField="id" required="true"/>
											</div>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td style="text-align: right; padding-top: 5px; padding-right:10px;"
									...
									<input id="id" name="ake003" class="mini-hidden" />
		...
		<fieldset>
			<div class="mini-splitter nobor"
				...
				<div size="55%" showCollapseButton="false" class="listTit">
					...
					<div id="chartPie" style="width:50%; height: 210px;">
					
					</div>
					<div id="" style="width: 50%; height: 50px;">
				...
				<div showCollapseButton="false" class="listTit">
					...
					<span class="btnMini">
						<em>
							<input type="button" value="问题登记" onclick="problemReg1()"/>
						</em>
					</span>
					<span class="btnMini">
						<em>
					...
					<div id="grid1" class="mini-datagrid" idField="id"
						...
						url="${pageContext.request.contextPath}/k6/f10603001/queryCharge.action">
						<div property="columns">
							...
							<div field="ratio" width="100" headerAlign="center" align="center" >
								占分项费用比(%)
							</div>
							<div field="allratio" width="100" headerAlign="center" align="center" >
								总费用占比(%)
							</div>
						</div>
					</div>
		...
		<script type="text/javascript">
			...
			function search(){
				...
				var url='${pageContext.request.contextPath}/k6/f10603001/queryInvoice.action';
				getChartData(url, data, function(datas) {
					if(radio1.getValue()=="1")
						showPieChart('chartPie', '', datas, " ", " ");
					else if(radio1.getValue()=="2")
						showColumnChart('chartPie', '', datas, " ", " ");
				});
			}
			...
			function zbpm(){
				...
				if(record){
					...
					var data = queryForm.getData(true);
					mini.open({
						url : "${pageContext.request.contextPath}/pages/k6/f10603001/f10603001_info.jsp",
