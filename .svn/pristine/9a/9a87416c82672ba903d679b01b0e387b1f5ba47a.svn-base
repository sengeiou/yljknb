...
<body>
						...
						<div id="sp2" class="mini-splitter"
							...
							<div size="50%" showCollapseButton="false">
								...
								<div id="datagrid1" class="mini-datagrid"
									...
									url="${pageContext.request.contextPath}/k5/f10507002/queryMedDocument.action">
							...
							<div size="50%" showCollapseButton="false">
								...
								<div id="datagrid2" class="mini-datagrid" style="height: 100%;"
									...
									showColumnsMenu="true"
									url="${pageContext.request.contextPath}/k5/f10507002/querySuspectedDocumentDetail.action">
									<div property="columns">
										<div type="checkcolumn"></div>
										<div type="expandcolumn">~</div>
										<div field="baz031" type="comboboxcolumn" width="100"
	...
	<script type="text/javascript">
							...
							if (text.success) {
								...
								for ( var i = 0; i < text.result.length; i++) {
									...
									htmlStr += "<td style='padding-bottom:6px;'><div class='td_number'>"
											+ text.result[i].dfysq
											+ "</div>	</td>";
									/* htmlStr+="<td style='padding-bottom:6px;'><div class='td_number2'>"+text.result[i].cqs+"</div>	</td>"; */
									htmlStr += "</tr>";
		...
		function onShowRowDetail2(e) {
			...
			$
					.ajax({
						url : "${pageContext.request.contextPath}/k5/f10507002/querySusDocumentDetailIllegal.action",
						type : "post",
						data : {
							baz001 : row.baz001,
							baz003 : row.baz003
