	...
	<body style="overflow-x: hidden; overflow-y: hidden;">
		<div id="editForm1" class="cxTabbox">
			...
			<div class="mainlistCon">
				...
				<div id="datagrid1" class="mini-datagrid" style="width: 100%; height: 150px;" idField="id" multiSelect="true"
					...
					url="${pageContext.request.contextPath}/k3/f10301010/queryRecheckDetail.action">
		...
		<script type="text/javascript">
			...
			function showApprovalTab(aaz318){
			  if(aaz318 != null){
					mini.open({
						url: "${pageContext.request.contextPath}/pages/k3/f10301019/f10301019_approval.jsp",
						title: "稽核案件多重审批",
						width: 800, 
						height: 400,
						onload: function (){
