package com.wondersgroup.bc.k5.f10509001.bs.impl;
...
import com.wondersgroup.bc.medicarecostaudit.medaudit.model.bo.Kc83;
import com.wondersgroup.bc.medicarecostaudit.medaudit.model.bo.Ke03;
...
public class F10509001BSImpl implements F10509001BS {
	...
	public List<Kc65DTO> findCaseID(String ids) {
		String baz011s = "";
		String[] id = ids.split(",");
		...
		String sql = "select * from kc65 where baz031='11' and baz011 in ( "
				+ baz011s + ")";
	...
	public Page queryKc65WithPage(Page page, Kc65DTO queryDto) {
		StringBuffer sql = new StringBuffer(
				" select a.* from kc65 a  where 1 = 1 and a.baz031='11' ");
		if (StringTools.hasText(queryDto.getBaz021())) {
			sql.append(" and a.baz021 = '" + queryDto.getBaz021() + "' ");
		}
	...
	public List<Kc65DTO> findKc65CaseID(String ids) {
		...
		String sql = "select * from kc65 where baz031='02' and baz011 in ( "
				+ baz011s + ")";
	...
	public Kc83DTO saveKc83(Kc83DTO kc83Dto) {
		if (kc83Dto == null) {
		...
		BeanTools.copyProperties(kc83Dto, kc83);

		String baz013 = CommonHibernateDaoUtils.getSequenceValue("SEQ_BAZ013");

		kc83.setBaz013(baz013);
		
		CommonHibernateDaoUtils.save(kc83);

		BeanTools.copyProperties(kc83, kc83Dto);

		return kc83Dto;
	}

	public Kc65DTO updateKc65(Kc65DTO kc65Dto) {
		if (kc65Dto == null) {
			throw new BusinessException("F10204001BS:传入参数kc62Dto为空!");
		}
		...
		Kc65 kc65 = CommonHibernateDaoUtils.load(Kc65.class,
				kc65Dto.getBaz011());

		BeanTools.copyPropertiesIgnoreNull(kc65Dto, kc65);

		CommonHibernateDaoUtils.update(kc65);
	...
	public Ke03DTO saveKe03(Ke03DTO ke03DTO) {
		Ke03 ke03=new Ke03();
		BeanTools.copyPropertiesIgnoreNull(ke03DTO, ke03);
		String baz014=CommonHibernateDaoUtils.getSequenceValue("SEQ_BAZ014");
		ke03.setBaz014(baz014);
		StringBuffer sql = new StringBuffer(" insert into ke03(baz014, baz013, baz035, baz036, baz037, baz038, baz039)");
		
		if(StringTools.hasText(ke03.getBaz014())){
			sql.append("values('"+ ke03.getBaz014() +"', '"+ ke03.getBaz013() +"', '" +ke03.getBaz035() + "', '" +ke03.getBaz036() +"', '"+ke03.getBaz037()+"', '"+ke03.getBaz038()+"', "+"sysdate"+")");
		}
		CommonJdbcDaoUtils.insert(sql.toString());
		BeanTools.copyProperties(ke03, ke03DTO);
		return ke03DTO;
	}
}
