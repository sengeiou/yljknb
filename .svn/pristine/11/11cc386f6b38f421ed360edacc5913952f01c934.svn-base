								...
								<tr>
									<td style="width:100%;"><span class="btnMini"
										style="margin:0 10px;"><em><input type="button"
												onclick="plcl('15')" value="通过" /> </em> </span> <span class="btnMini"
										style="margin:0 10px;"><em><input type="button"
												onclick="plcl('16')" value="不通过" /> </em> </span> <input id="baz003s"
										name="baz003s" class="mini-hidden" value="" /></td>
								</tr>
							</table>
						</div>
						<div id="datagrid1" class="mini-datagrid"
							style="width: 100%; height: 86%;" idField="id" multiSelect="true"
							allowResize="false" pageSize="50" showColumnsMenu="true"
							sortMode="client" onrowdblclick="queryHistory"
							url="${pageContext.request.contextPath}/k2/f10205001/queryMedDocument.action">
	...
	<script type="text/javascript">
		...
		function plcl(baz031) {
			...
			if (baz031 == '15') {
				mini
						.open({
							url : "${pageContext.request.contextPath}/pages/k2/f10205001/f10205001_plcl.jsp",
							title : '通过',
							width : 350,
							height : 200,
							onload : function() {
