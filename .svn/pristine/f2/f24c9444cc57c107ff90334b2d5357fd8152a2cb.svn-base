...
<body>
	...
	<script type="text/javascript">
		...
		function SetData(data){
		     	...
		     	$.ajax({
		     		url:"${pageContext.request.contextPath}/k5/f10503001/toOrgVioCompRegAdd.action?method=toOrgVioCompRegAdd",
		     		type:"post",
		...
		function SaveData() {
			...
			$.ajax({
				url: "${pageContext.request.contextPath}/k5/f10503001/addOrgVioCompReg.action?method=addOrgVioCompReg",
				type: "post",
