...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
		   var ac62Baz031 = [{id:'05',text:'送核查'},{id:'06',text:'医院送复审'}];
		</script>
		<style type="text/css">
	...
	<body>
		...
		<div class="mainlistCon">
			...
			<div id="datagrid1" class="mini-datagrid"
				...
				url="${pageContext.request.contextPath}/k5/f10501001/queryFeedbackMedDocument.action">
					...
					<div id="detail_tabs" class="mini-tabs" activeIndex="0"
						...
						<div title="费用明细">
							<div id="datagrid2" class="mini-datagrid" style="height: 100%;"
								...
								url="${pageContext.request.contextPath}/k5/f10501001/queryFeedbackMedDocumentDetail.action">
								<div property="columns">
									<div type="checkcolumn"></div>
									...
									<table cellpadding="0" class="cxTab" cellspacing="0" border="0"	width="100%">
										...
										<tr>
											<td nowrap="nowrap" colspan="3" style="text-align: center; padding-top: 5px;">
												<span class="btnMini"><em><input type="button" onclick="preCheck('06')" value="医院送复审"/></em></span>
											</td>
										</tr>
									</table> 
								</form> 
	...
	function onShowRowDetail1(e) {
        ...
        $("#detailgrid1").html("");
        $.ajax({
            url: "${pageContext.request.contextPath}/k5/f10501001/queryFeedbackMedDocumentIllegal.action",
            type: "post",
	...
	function onShowRowDetail2(e) {
        ...
        $("#detailgrid2").html("");
        $.ajax({
            url: "${pageContext.request.contextPath}/k5/f10501001/queryFeedbackMedDocumentDetailIllegal.action",
            type: "post",
    ...
    function preCheck(baz031){
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/k5/f10501001/medDocumentDetailFeedbackOperate.action",
            type: "post",
