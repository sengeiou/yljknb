...
public class PersonDTO {
	...
	private String aac001; //对象ID	
	private String aaz010;
	private String abb057; //监控日期	
    private String abb057begin;//开始日期	
	private String abb057end;//结束日期	
	private String apa151; //监控等级	
    private String aae140; //险种	
	private String akc021;//身份类别		
	private String aka122;//病种	
	private String aka130;//医疗类别	
	private String aaa178;//规则医疗类别
	private String ake003;//三目类别	
	private String aka065;//收费等级		
	private String ape031;//疑点状态	
	private String aaa153; //规则分类	
	private String aaa155;//阈值级别
	private String aaa027;//统筹区
	private String aka101;//医院等级	
	private String akb021;//医院名称
	private String akb020;//医疗服务机构编号	
	private String mid;//ID串，以,号分隔
	private String rules;//规则id列表
	
	private String wgtype;//违规类型 ，严重，较严重，关注
	...
	public String getAbb057() {
		return abb057;
	}

	public void setAbb057(String abb057) {
		this.abb057 = abb057;
	}
	...
	public String getAaa155() {
		return aaa155;
	}

	public void setAaa155(String aaa155) {
		this.aaa155 = aaa155;
	}
	...
	public String getAbb057begin() {
		return abb057begin;
	}

	public void setAbb057begin(String abb057begin) {
		this.abb057begin = abb057begin;
	}

	public String getAbb057end() {
		return abb057end;
	}

	public void setAbb057end(String abb057end) {
		this.abb057end = abb057end;
	}
