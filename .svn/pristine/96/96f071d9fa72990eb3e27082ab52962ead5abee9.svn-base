		...
		<form id="form1" action="" method="post">
			...
			<fieldset style="width: 100%; border: solid 0px #aaa;">
				...
				<div id="editForm1" style="margin: 10px; position: relative;">
					<table class="cxTab" cellpadding="0" cellspacing="0" border="0" width="100%">
						...
						<td>
							<div class="inputL" style="width:130px">
								<div class="inputR">
									<div class="inputC">
										<input id="ape712Operate" name="ape712Operate" class="mini-datepicker" allowInput="false"
					...
					<tr>
						<td nowrap="nowrap" colspan="5" style="text-align: center; padding-top: 5px;" class="mainlistCon">
						<!-- <span class="btnMini">
							<em>
						...
						<span class="btnMini">
							<em>
								<input type="button" onClick="filedownload();" value="下载附件" /> 
							</em> 
						</span>
						</td>
					</tr>
		...
		<script type="text/javascript">
			...
			function sourceWay(){
		     ...
		     function filedownload() {
		     	var data = form.getData();
		     	var aaz381 = data.aaz381;
				$
				.ajax({
					url :"${pageContext.request.contextPath}/k3/f10301016/fileExist.action",
					type : "post",
					data : {
						aaz381 : aaz381
					},
					success : function(text) {
						if(text.success){
							location.href="${pageContext.request.contextPath}/k3/f10301016/downLoad.action?aaz381="+aaz381;
						}else{
							mini.alert('文件不存在');
						}
