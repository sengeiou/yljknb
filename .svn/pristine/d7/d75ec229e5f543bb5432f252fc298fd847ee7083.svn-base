package com.wondersgroup.local.k5.f10508001.vo;
...
public class Kc62VO  extends Kc62DTO{
	...
	private String baz022str;//医院端显示
	...
	public String getBaz022str() {
		return baz022str;
	}

	public void setBaz022str(String baz022str) {
		this.baz022str = baz022str;
	}
