...
<body>
						...
						<div id="sp2" class="mini-splitter"
							...
							<div size="38%" showCollapseButton="false">
								<div id="datagrid1" class="mini-datagrid"
									...
									sizeList="[10,20,50,100,500]" multiSelect="true"
									allowResize="false" pageSize="50"
									onselectionchanged="queryDetail" onload="afterload"
									showColumnsMenu="true" sortMode="client"
									url="${pageContext.request.contextPath}/k5/f10508001/queryMedDocument.action">
							...
							<div size="62%" showCollapseButton="false">
										...
										<tr>
											<td style="width:100%;"><span class="btnMini"
												style="margin: 0px 20px 2px 20px;"><em><input
														type="button" value="导出EXCEL" onclick="ExportExcel();" />
												</em> </span>
											</td>
										</tr>
									</table>
								...
								<div id="datagrid2" class="mini-datagrid" style="height: 86%;"
									...
									sizeList="[10,20,50,100,500]" showSummaryRow="true"
									showColumnsMenu="true" sortMode="client"
									url="${pageContext.request.contextPath}/k5/f10508001/queryMedDocumentDetail.action">
									<div property="columns">
										<div type="checkcolumn"></div>
	...
	<!--导出Excel相关HTML-->
	<form id="excelForm"
		action="${pageContext.request.contextPath}/k5/f10508001/f08exportExcel.action"
		method="post" target="excelIFrame">
		<input type="hidden" name="columns" id="columns" /> <input
			type="hidden" name="bazids" id="bazids" />
	</form>
