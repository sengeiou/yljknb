...
<body>
			...
			<form id="form1" action="#">
				<table class="cxTab" cellpadding="0" cellspacing="0" border="0"
					...
					<tr>
						...
						<td style=" padding-left: 25px;">至</td>
						<td>
							<div class="inputL" style="width: 130px">
								<div class="inputR">
									<div class="inputC">
										<input id="akc194End" name="akc194End" format="yyyyMMdd"
											class="mini-datepicker" />
									</div>
								</div>
							</div></td>
						...
						<td></td>
						<td
							style="text-align: center; padding-top: 5px; padding-left: 55px"
							colspan="2"><input type="button" value="" class="cxsubmit"
	...
	<div class="mainlistCon">
		...
		<div id="datagrid1" class="mini-datagrid"
			...
			url="${pageContext.request.contextPath}/k2/f10201003/queryCheckMedDocument.action">
			<div property="columns">
				...
				<div field="baz001" width="100" headerAlign="center">违规单据ID</div>
				<div field="aaz370" width="100" headerAlign="center">就诊编号</div>
				<div field="aaz308" width="100" headerAlign="center">结算信息ID</div>
				<div field="aac003" width="100" headerAlign="center">参保人姓名</div>
				<div field="aac002" width="100" headerAlign="center">社会保障号</div>
				<div field="aac001" width="100" headerAlign="center">参保人ID</div>
				...
				<div field="aac006" width="100" headerAlign="center">参保人出生日期</div>
				...
				<div field="akb020" width="100" headerAlign="center">医疗服务机构编号
				</div>
				<div field="akb021" width="100" headerAlign="center">医疗服务机构名称
				</div>
				<div field="akb022" type="comboboxcolumn" width="100"
					headerAlign="center">
					医疗服务机构类型<input property="editor" class="mini-combobox"
						style="width:100%" data="${dic['AKB022']}">
				</div>
				<div field="aaz307" width="100" headerAlign="center">科室编码</div>
				...
				<div field="aaz263" width="100" headerAlign="center">医护人员编号</div>
				...
				<div field="akc194" dateFormat="yyyyMMdd" width="100"
					headerAlign="center">就诊结算时间</div>
				<div field="ake038" width="100" headerAlign="center">个人账户支出</div>
				<div field="akc254" width="100" headerAlign="center">个人自付金额</div>
				<div field="akc253" width="100" headerAlign="center">自费金额</div>
				<div field="akb067" width="100" headerAlign="center">个人现金支付金额
				</div>
				<div field="akc264" width="100" headerAlign="center">总费用</div>
				<div field="akc050" width="100" headerAlign="center">入院疾病诊断名称
				</div>
				<div field="akc193" width="100" headerAlign="center">入院疾病诊断代码
				</div>
				<div field="akc185" width="100" headerAlign="center">出院主要疾病诊断
				</div>
				<div field="aka120" width="100" headerAlign="center">出院主要诊断编码
				</div>
				<div field="akc186" width="100" headerAlign="center">出院次要疾病诊断
				</div>
				...
				<div field="baz020" dateFormat="yyyyMMdd" width="100"
					headerAlign="center">智能审核时间</div>
				<div field="baz022" width="100" headerAlign="center">智能审核结果说明
				</div>
		...
		<div class="mini-splitter nobor" style="width: 100%; height: 200px;">
				...
				<div id="detail_tabs" class="mini-tabs" activeIndex="0"
					...
					<div title="费用明细">
						<div id="datagrid2" class="mini-datagrid" style="height: 100%;"
							...
							url="${pageContext.request.contextPath}/k2/f10201003/queryCheckMedDocumentDetail.action">
							<div property="columns">
								<div type="checkcolumn"></div>
								<div type="expandcolumn">~</div>
								<div type="talkcolumn" width="40" renderer="onZtGenderRenderer">~</div>
								<div field="baz031" type="comboboxcolumn" width="100"
									headerAlign="center">
									审核状态<input property="editor" class="mini-combobox"
										data="${dic['BAZ031']}">
								...
								<div field="aaz213" width="100" headerAlign="center">明细ID
								</div>
								<div field="aaa027" width="100" headerAlign="center">统筹区</div>
							</div>
						</div>
					...
					<div title="就诊信息">
						<div class="infoTab">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<th width="10%">机构编号：</th>
									<td><span id="akb020_jz"></span></td>
									<th width="10%">个人编号：</th>
									<td><span id="aac001_jz"></span></td>
									<th width="10%">社会保障号：</th>
									<td><span id="aac002_jz"></span></td>
								</tr>
								<tr>
									<th width="10%">参保人：</th>
									<td><span id="aac003_jz"></span></td>
									<th width="10%">险种类型：</th>
									<td><span id="aae140_jz"></span></td>
									<th width="10%">就诊类型：</th>
									<td><span id="aka130_jz"></span></td>
								</tr>
								<tr>
									<th width="10%">入院日期：</th>
									<td><span id="aae030_jz"></span></td>
									<th width="10%">出院日期：</th>
									<td><span id="aae031_jz"></span></td>
									<th width="10%">结算日期：</th>
									<td><span id="akc194_jz"></span></td>
								</tr>
								<tr>
									<th width="10%">医疗费总额：</th>
									<td colapan="5"><span id="akc264_jz"></span></td>
								</tr>
							</table>
							<br /> 诊断信息<br />
							<br />
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<th width="15%">主要疾病诊断：</th>
									<td colspan="5"><span id="akc185_jz"></span></td>
								</tr>
								<tr>
									<th width="15%">次要疾病诊断：</th>
									<td colspan="5"><span id="akc186_jz"></span></td>
								</tr>
								<tr>
									<th width="15%">疾病第三诊断：</th>
									<td colspan="5"><span id="akc274_jz"></span></td>
								</tr>
								<tr>
									<th width="15%">疾病第四诊断：</th>
									<td colspan="5"><span id="akc276_jz"></span></td>
								</tr>
							</table>
						</div>
					</div>
			...
			<div showCollapseButton="false" style="padding: 5px;">
				<div id="audit_tabs" class="mini-tabs" activeIndex="0"
							...
							<form id="form2" action="#">
								<table cellpadding="0" class="cxTab" cellspacing="0" border="0"
									...
									<tr>
										...
										<td align="right">&nbsp;
											<div id="ck1" name="deductAllFlag" class="mini-checkbox"
												checked="false" readOnly="false" text="扣除全部"
												onvaluechanged="onValueChanged"></div></td>
										<td>医师扣分:</td>
										<td width="60">
											<div class="inputL" style="width: 50px">
												<div class="inputR">
													<div class="inputC">
														<input id="bae041" name="bae041" data="bae041" value="0"
															class="mini-combobox" />
													</div>
												</div>
											</div></td>
											...
											<div style="padding-right:4px;">
												...
												<div class="textareaLay">
													...
													<input id="medDetailListStr" name="medDetailListStr"
														...
														id="baz033" name="baz033" class="mini-hidden"
														required="true" />
												</div>
									...
									<tr>
										<td nowrap="nowrap" colspan="5"
											...
											class="btnMini"><em><input type="button"
													onclick="preCheck('01')" value="正常" />
											</em>
										</span> <span class="btnMini"><em><input type="button"
													onclick="preCheck('09')" value="直接扣款" />
											</em>
										</span> <span class="btnMini"><em><input type="button"
													onclick="preCheck('10')" value="送稽核" />
											</em>
										</span></td>
									</tr>
								</table>
					...
					<div title="审核日志">
						<div id="checkRecord" class="auditBox mini-datagrid"
							style="height: 100%;" showColumns="false" showPager="false"
							...
							<div property="columns">
								...
								<div field="baz031" type="comboboxcolumn" width="80"
									headerAlign="center">
								...
								<div field="bae041Str" width="100" headerAlign="center">
									医师扣分</div>
								<div field="baz022" width="50" headerAlign="center">审核人</div>
								<div field="baz023Str" dataType="date" dateFormat="yyyy-MM-dd"
									width="100" headerAlign="center">审核时间</div>
							</div>
						</div>
					</div>
				</div>
		...
		<script type="text/javascript">
			...
			function onShowRowDetail1(e) {
				...
				$
						.ajax({
							url : "${pageContext.request.contextPath}/k2/f10201003/queryCheckMedDocumentIllegal.action",
							type : "post",
							data : {
								baz001 : row.baz001
							},
			...
			function onShowRowDetail2(e) {
				...
				$
						.ajax({
							url : "${pageContext.request.contextPath}/k2/f10201003/queryCheckMedDocumentDetailIllegal.action",
							type : "post",
							data : {
								baz001 : row.baz001,
								baz003 : row.baz003
			...
			function preCheck(baz031) {
				...
				$
						.ajax({
							url : "${pageContext.request.contextPath}/k2/f10201003/medDocumentDetailCheckOperate.action",
							type : "post",
							data : {
								submitData : json
							},
			...
			function onZtGenderRenderer(e) {
				var record = e.row;
				return "<a href='javascript:void(0)' onclick = showMess('"
						+ record.baz003
						+ "')><img src='../../images/ssxx.png' /></a> ";
			}
