...
<%@ include file="../../../pages/pub/pubsource.jsp"%>
	...
	<body>
		<form id="form1" action="" method="post">
			<input id="aaz281s" name="aaz281s" value="" class="mini-hidden" required="true"/>
								...
								<td colspan="4">
									<div style="padding-right:4px;">
										...
										<div class="textareaLay">
											<!-- <input id="aae200" name="aae200" class="mini-textarea" style="width:460px;height:100px;" 
												required="true" vtype="maxLength:200"/> -->
												<textarea id="aae200" name="aae200" class="mini-textarea"	emptyText="请输入处理意见" required="true" style="height: 100px;width: 300px;"></textarea>
										</div>
		...
		<script type="text/javascript">
			...
			//返回
     		...
     		function saveRejectInfo(){
        		...
        		mini.confirm("经简单处理后的记录将不进稽查流程","确认",
					function(action){
						if (action == "ok"){
							mini.mask({el: document.body,cls: 'mini-mask-loading',html: '处理中...'});
							$.ajax({
								url: "${pageContext.request.contextPath}/k3/f10301001/simpExcute.action",
								type:"post",
								data: {aaz281s: data.aaz281s,aae200: data.aae200},
