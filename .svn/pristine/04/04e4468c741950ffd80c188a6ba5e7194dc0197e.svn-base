...
@MappedSuperclass
public abstract class BaseAf62 {
	 private long baz071;
     ...
     private Date aae036;
     private String ake079;
     private String aaz010;
     private String ape008;
     
     @Id
     @Column(name = "BAZ071",  unique = true, nullable = false,precision = 16, scale = 0)
     public long getBaz071(){
          return this.baz071;
     }
     public void setBaz071(long baz071){
          this.baz071 = baz071;
     }
     ...
     @Column(name = "AKE079", length = 500)
     public String getAke079(){
          return this.ake079;
     }
     public void setAke079(String ake079){
          this.ake079 = ake079;
     }
