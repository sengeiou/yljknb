...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<form id="form1" action="" method="post">
			...
			<div id="editForm1" style="margin: 10px; position: relative;">
				<table class="cxTab" cellpadding="0" cellspacing="0" border="0">
					<tr>
						...
						<td>
							<div class="inputL" style="width: 130px">
								<div class="inputR">
									<div class="inputC">
										<input name="aaa153" class="mini-combobox" emptyText="请选择受理方式"
					...
					<tr>
						...
						<td>
							<div class="inputL" style="width: 130px">
								<div class="inputR">
									<div class="inputC">
										<input id="zlfa" allowInput="false" name="aaz321"
					...
					<tr>
						...
						<td>
							<div class="inputL" style="width: 130px">
								<div class="inputR">
									<div class="inputC">
										<input id="sxfa" onvalidation="checkButtonEdit" allowInput="false" class="mini-buttonedit"
					...
					<tr>
						<td
							style="text-align: right; padding-top: 5px; padding-right:25px;" colspan="4">
    ...
    function SaveData() {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/k4/f10402001/saveModel.action",
            type: "post",
   	...
   	function openQueryScheme(type,btn){
   	 ...
   	 function SetData(){
     	$.ajax({
     		url:"${pageContext.request.contextPath}/k4/f10402001/loadModelInitData.action",
     		type:"post",
     		success: function (text){
     			var data = mini.decode(text);
		        form.setData(data);
