...
public class HospitalDTO {
	...
	private String akb020;//医疗机构 编号

	private String akb021;//医疗机构名称

	private String akb022;//医疗机构类型

	private String aka101;//医疗机构等级

	private String akb012;//医疗机构评级

	private String akb026;//执业许可证登记号
