							...
							<div style="padding-right: 4px;">
								...
								<div class="textareaLay">
									<textarea id="baz021" name="baz021" class="mini-textarea"
										emptyText="请输入主动复议意见"></textarea>
									<input id="baz102" name="baz102" class="mini-hidden"
										required="true" /> <input id="baz102" name="baz102"
...
<script type="text/javascript">
	...
	function SaveData() {
        ...
        $.ajax({
          url: "${pageContext.request.contextPath}/k5/f10507001/preCheckBatch.action",
          type: "post",
          data: param,
          dataType : 'json',
