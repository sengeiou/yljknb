	...
	<body>
		...
		<script type="text/javascript">
			...
			function onButtonEdit(e){
				...
				mini.open({
					url:"${pageContext.request.contextPath}/pages/k3/f10301020/f10301020_selectcase.jsp",
					title:"查询案件信息",
					width: 700,
                	height: 480,
			...
			function showApprovalTab(aaz318){
			  if(aaz318 != null){
					mini.open({
						url: "${pageContext.request.contextPath}/pages/k3/f10301020/f10301020_approval.jsp",
						title: "结论确认多重审批",
						width: 800, 
						height: 400,
						onload: function (){
			...
			function affirm(aaz077 ,aaz318,apa011){
				if(aaz077 != null && aaz318 != null){
					mini.open({
						url:"${pageContext.request.contextPath}/pages/k3/f10301020/f10301020_shms.jsp",
						title:"稽核结论确认",
						width:500,
						height:180,
						onload:function(){
