    	...
    	<div id="editForm1" style="margin: 1px;position: relative;">
    		<table class="form-table" border="0" cellpadding="1" cellspacing="2" style="width: 100%">
    			...
    			<tr>
    				<td>排斥三大目录类别：</td>
    				<td>
    					<input id="rtcc" class="mini-combobox" emptyText="请选择..." 
    				           style="width: 200px;" data="tcc"/>
    				</td>
    				<td>排斥三大目录名称:</td>
    				<td>
    					<input id="rtcn" class="mini-buttonedit"  style="width: 200px;"
    	...
    	<div style="width: 100%;">
    		...
    		<div id="grid1" class="mini-datagrid" idField="id" multiSelect="true"
                 ...
                 <div property="columns">
	                ...
	                <div field="" width="100" headerAlign="center" allowSort="true">排斥三大目录类别</div>
	                <div field="" width="100" headerAlign="center" allowSort="true">排斥三大目录名称</div>
