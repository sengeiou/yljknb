package com.wondersgroup.local.k3.f10301017.vs.impl;
...
public class F10301017VSImpl implements F10301017VS{
	
	private F10301017BS f10301017bs;
	
	public F10301017BS getF10301017bs() {
		return f10301017bs;
	}

	public void setF10301017bs(F10301017BS f10301017bs) {
		this.f10301017bs = f10301017bs;
	}

	public List<QueryApprovalVo> queryData(String aaz318) {
		if ("0" == aaz318) {
			throw new BusinessException("F10301017VSImpl:aaz318 is null");
		}
		return this.getF10301017bs().queryApproalData(aaz318);
	}
	...
	public QueryApprovalVo operateApproval(QueryApprovalVo approvalVo) {
		...
		ApprovalClassList acl = this.getF10301017bs().qryMaxApprovalId();
		if(approvalVo.getAclid().equals(acl.getAclid())){
			 String aae189 = approvalVo.getAilyj();
			 List<Af53DTO> af53Dtos = this.getF10301017bs().findCaseID(approvalVo.getAaz318()+"");
			 ...
			 for(Af53DTO af53Dto : af53Dtos){
				...
				//更新审案状态
				this.getF10301017bs().updateAf53(af53Dto);
			}
		}else if ("否".equals(approvalVo.getAiltg())) {
			String aae189 = approvalVo.getAilyj();
			List<Af53DTO> af53Dtos = this.getF10301017bs().findCaseID(approvalVo.getAaz318()+"");
		...
		return this.getF10301017bs().operateApproval(approvalVo);
	}

	public void jumpOut(String aaz318) {
		this.getF10301017bs().jumpOut(aaz318);
