...
public class QueryDxzbMessage extends BaseAjaxAction {
	...
	protected String operate() {
		...
		String dxid = this.getServletRequest().getParameter("dxid");
		...
		resultVO = this.getF10402007VS().queryDxzbMessage(page, dxzbVO);
