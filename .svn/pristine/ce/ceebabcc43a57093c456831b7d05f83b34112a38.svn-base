...
<body>
						...
						<div id="sp2" class="mini-splitter"
							...
							<div size="50%" showCollapseButton="false">
								...
								<div id="datagrid1" class="mini-datagrid"
									...
									onshowrowdetail="onShfowRowDetail1" onload="afterload"
									showColumnsMenu="true"
									url="${pageContext.request.contextPath}/k5/f10506003/queryCompain.action">
							...
							<div size="50%" showCollapseButton="false">
								...
								<div id="datagrid2" class="mini-datagrid" style="height: 100%;"
									...
									showColumnsMenu="true"
									url="${pageContext.request.contextPath}/k5/f10506003/querySuspectedDocumentDetail.action">
									<div property="columns">
										<div type="checkcolumn"></div>
										<div type="expandcolumn">~</div>
										<div field="baz031" type="comboboxcolumn" width="100"
	...
	<script type="text/javascript">
		...
		function onShowRowDetail2(e) {
			...
			$
					.ajax({
						url : "${pageContext.request.contextPath}/k5/f10506003/querySusDocumentDetailIllegal.action",
						type : "post",
						data : {
							baz001 : row.baz001,
							baz003 : row.baz003
	...
	/* 	function queryCheckRecord(e) {
		...
		function queryNumber() {
			...
			$
					.ajax({
						url : "${pageContext.request.contextPath}/k5/f10506003/queryNumber.action",
						type : "post",
						data : {
						...
						success : function(text) {
							if (text.success) {
								...
								for ( var i = 0; i < text.result.length; i++) {
									...
									htmlStr += "<td style='padding-bottom:6px;'>待复议申请审核审核数：</td>";
									htmlStr += "</tr>";
