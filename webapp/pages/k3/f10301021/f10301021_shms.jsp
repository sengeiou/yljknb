...
<body style="background-color:#F3F3F3 ;">
	<div class="mainlistCon">
		<div style="text-align:center; margin:10px;">
			<form id="form" action="#">
				<input id="apa011" 	name="apa011" class="mini-hidden"  /> 
	...
	<script type="text/javascript">
		...
		var form = new mini.Form("form");
		 ...
		 function setData(data){
   				...
   				mini.get("apa011").setValue(data.apa011);
   		}
   		...
   		function saveData(){
	        ...
	        $.ajax({
	            url: "${pageContext.request.contextPath}/k3/f10301011/operateCaseInfo.action",
	            type : "post",
