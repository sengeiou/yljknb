...
<%@ include file="../../../pages/pub/pubsource.jsp"%>
	...
	<body>
		...
		<div id="grid1" class="mini-datagrid" style="width: 100%; height: 370px;" idField="id" multiSelect="true"
				...
				url="${pageContext.request.contextPath}/k3/f10301024/queryApprovalData.action">
		...
		<script type="text/javascript">
			...
			function jumpOut() {
				...
				$.ajax({
					url : "${pageContext.request.contextPath}/k3/f10301024/jumpOut.action",
					type : "post",
					data : {aaz318 : aaz318},
			...
			function precheck(ailid,aclid,aaz318,ailtg){
						...
						if (2 == aclid  && !("未审批" == ailzt)) {
							mini.open({
								url: "${pageContext.request.contextPath}/pages/k3/f10301024/f10301024_sptg.jsp",
								title: "结论确认审批",
								width: 600, 
								height: 220,
								onload: function (){
