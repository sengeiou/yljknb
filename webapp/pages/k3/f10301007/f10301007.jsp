	...
	<body>
			...
			<div class="mainlistCon">
				<div class="listTit">
					...
					<div id="grid1" class="mini-datagrid" style="width: 100%; height: 170px;" allowResize="false"
						 ...
						 url="${pageContext.request.contextPath}/k3/f10301007/loadAuditCaseInfoByAbz001.action?method=loadAuditCaseInfoByAbz001">
						<div property="columns">
							...
							<div field="aaz281" width="100" headerAlign="center" visible="false">疑点问题受理记录ID</div>
							<div field="abz001" width="100" headerAlign="center" visible="false">案件编号</div>
			...
			<div class="mainlistCon">
				<div class="listTit">
					...
					<div id="grid2" class="mini-datagrid" style="width: 100%; height: 178px;" 
						 ...
						 url="${pageContext.request.contextPath}/k3/f10301007/loadAuditTargetByAaz318.action?method=loadAuditTargetInfoByAaz318">
						<div property="columns">
							<div type="indexcolumn"></div>
							...
							<div field="apa011" width="100" headerAlign="center" type="comboboxcolumn">
								对象确认状态<input property="editor" class="mini-combobox" style="width:100%" data="${dic['APA011']}">
							</div>
		...
		<script type="text/javascript">
			...
			function onButtonEdit(e){
				...
				mini.open({
					url:"${pageContext.request.contextPath}/pages/k3/f10301007/f10301007_selectcase.jsp",
					title:"查询案件信息",
					width: 700,
                	height: 480,
			...
			function rendererGrid1(e){
            	...
            	var s1 = "<a href='###' onclick = confirmToSurvey('" + record.aaz318 + "') >是否通过？</a>";
            	return s + " | " + s1;
			}
			
			function confirmToSurvey(aaz318){
				if(aaz318 != null){
					mini.open({
						url:"${pageContext.request.contextPath}/pages/k3/f10301007/f10301007_confirm.jsp",
						title:"稽核结论确认",
						width:300,
						height:150,
						onload:function(){
			...
			function rendererGrid2(e){
            	...
            	//var s2 = "<a href='###' onclick = affirm('" + record.aaz077 + "','"	+ record.aaz318 + "') >确认</a>";
            	//var s = s1 + " | " + s2;
            	return s1;
			}
			...
			//确认
			function affirm(aaz077 , aaz318){
				if(aaz077 != null && aaz318 != null){
					mini.open({
						url:"${pageContext.request.contextPath}/pages/k3/f10301007/f10301007_affirm.jsp",
						title:"稽核结论确认",
						width:700,
						height:580,
						onload:function(){
