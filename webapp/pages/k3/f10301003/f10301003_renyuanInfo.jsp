	...
	<body>
		<form id="form_info" action="" method="post">
			...
			<fieldset style="width: 100%; border: solid 0px #aaa;">
				<!-- <h3 class="cxTit pTb8"><span class="iconCx">人员详情</span></h3> -->
						...
						<tr>
							...
							<td ><!--colspan="3"-->
								<div class="inputL" style="width:130px;">
									<div class="inputR">
										<div class="inputC">
											<input id="aab004" name="aab004" class="mini-textbox" style="width:100%;"/>
										</div>
									</div>
								</div>
							</td>
		...
		<script type="text/javascript">
			...
			function setData(data){
				...
				mini.mask({el: document.body,cls: 'mini-mask-loading',html: '正在加载数据...'});
				$.ajax({
					url:"${pageContext.request.contextPath}/common/loadStaffInfo.action?method=loadStaffInfo",
