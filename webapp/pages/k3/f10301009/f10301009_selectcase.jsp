						...
						<tr>
							...
							<td>
								<div class="inputL" style="width:130px">
								 	<div class="inputR">
								 		<div class="inputC">
											<input id="acc789" name="acc789" class="mini-textbox" style="width:100%;" />
										</div>
									</div>
								</div>
							</td>
							...
							<td>
								 <div class="inputL" style="width:130px">
								 	<div class="inputR">
								 		<div class="inputC">
											<input id="abb006" name="abb006" class="mini-combobox" style="width:100%;" 
		...
		<fieldset style="border: solid 0px #aaa; position: relative;">
			<div class="mainlistCon">
				...
				<div id="datagrid1" class="mini-datagrid" style="width:100%; height:300px;" showPageSize="true"
					...
					url="${pageContext.request.contextPath}/k3/f10301009/queryCaseTransTurn.action">
