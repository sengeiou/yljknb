...
<%@ include file="../../../pages/pub/pubsource.jsp"%>
	...
	<body>
		...
		<div id="grid1" class="mini-datagrid" style="width: 100%; height: 370px;" idField="id" multiSelect="true"
				...
				url="${pageContext.request.contextPath}/k3/f10301023/queryApprovalData.action">
		...
		<script type="text/javascript">
			...
			function jumpOut() {
				...
				$.ajax({
					url : "${pageContext.request.contextPath}/k3/f10301023/jumpOut.action",
					type : "post",
					data : {aaz318 : aaz318},
			...
			function precheck(ailid,aclid,aaz318,ailtg){
						...
						var grid = mini.get("grid1");
						mini.open({
							url: "${pageContext.request.contextPath}/pages/k3/f10301023/f10301023_sptg.jsp",
							title: "结论确认审批",
							width: 600, 
							height: 220,
							onload: function (){
