					...
					<table class="cxTab" cellpadding="0" cellspacing="0" border="0">
						<tr>
							...
							<td>
								...
								<input name="aaz100" class="mini-hidden"/>
								</td>
						...
						<tr>
							...
							<td> 
								<div class="inputL" style="width: 130px">
									<div class="inputR">
										<div class="inputC">
											<input name="aae011" enable="false" class="mini-textbox" readonly="readonly" />
										</div>
									</div>
								</div>								
							</td>
...
<script type="text/javascript">
	...
	function CloseWindow(action) {            
      ...
      function SetData(data){
     	...
     	$.ajax({
     		url:"${pageContext.request.contextPath}/k4/f10401001/loadPlanManage.action",
     		type:"post",
     		data: data,
    ...
    function SaveData() {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/k4/f10401001/updataPlanManage.action",
            type: "post",
