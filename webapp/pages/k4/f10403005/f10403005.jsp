...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <script type="text/javascript">
  	...
  	function searchDiseaseClassify(){
  		mini.open({
  			url: '${pageContext.request.contextPath}/pages/k4/searchJsp/diseaseClassify.jsp',
			title: '查询疾病分类', 
			width:850, 
			height:450,
  		});
    	...
    	<div id="editForm1" style="margin: 1px;position: relative;">
    		<table class="form-table" border="0" cellpadding="1" cellspacing="2" style="width: 100%">
    			...
    			<tr>
    				<td>疾病分类：</td>
    				<td>
    					<input id="dc" class="mini-buttonedit" onbuttonclick="searchDiseaseClassify()" 
    						   style="width: 320px;"/>
    				</td>
    				<td>有效标志：</td>
    				<td>
    		...
    		<div id="grid1" class="mini-datagrid" idField="id" multiSelect="true"
                 ...
                 url="#">
                 	<div property="columns">
	                 	...
	                 	<div field="" width="100" headerAlign="center" allowSort="true">限制疗程天数</div>
