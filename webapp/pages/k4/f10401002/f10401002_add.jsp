			...
			<div id="editForm1" style="margin: 10px; position: relative;">
				<table  class="cxTab" cellpadding="0" cellspacing="0" border="0">
					<tr >
						...
						<td>
							<div class="inputL" style="width: 130px">
									<div class="inputR">
										<div class="inputC">
											<input id="aae036" name="aae036" onvaluechanged="onValueChanged" class="mini-datepicker"
												readonly="readonly" />
										</div>
									</div>
							</div>
					...
					<tr>
						...
						<td> 
							<div class="inputL" style="width:130px">
									<div class="inputR">
										<div class="inputC">
											<input id="aae011" name="aae011" enable="false" class="mini-textbox"  required="false"
												 readonly="readonly" />
										</div>
									</div>
								</div>
					...
					<tr>
							...
							<td style="text-align: right; padding-top: 5px; padding-right: 37px;"
...
<script type="text/javascript">
		...
		var form = new mini.Form("#form1");
		 function SetData() {
			$.ajax( {
					url : "${pageContext.request.contextPath}/k4/f10401002/initDispatchData.action",
					type : "post",
    ...
    function SaveData() {
       ...
       // alert(json);
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/k4/f10401002/addDispatchManage.action",
            type: "post",
