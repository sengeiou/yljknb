...
<html xmlns="http://www.w3.org/1999/xhtml">
					...
					<tr>
						...
						<td>
							<div class="inputL" style="width: 130px">
								<div class="inputR">
									<div class="inputC">
										<input name="aae417" maxLength="50" class="mini-textbox"
											required="true" />
									</div>
								</div>
							</div>
	...
	function SetData(){
		$.ajax({
     		url:"${pageContext.request.contextPath}/k4/f10402003/initAnalysisRule.action",
     		type:"post",
	...
	function SaveData(){
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/k4/f10402003/saveAnalysisRule.action",
            type: "post",
