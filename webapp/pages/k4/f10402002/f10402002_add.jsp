...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form id="form" action="" method="post">
			...
			<div id="editForm1" style="margin: 10px; position: relative;">
				<table class="cxTab" cellpadding="0" cellspacing="0">
					<tr>
						<td class="textR">
							统筹区编码：
						</td>
								...
								<div class="inputR">
									<div class="inputC">
										<input onvalidation="checkButtonEdit" allowInput="false" class="mini-buttonedit"
											onbuttonclick="queryModel" name="aaz320" required="true" />
									</div>
								</div>
							</div>
						</td>
					...
					<tr>
						...
						<td>
							<div class="inputL" style="width: 130px">
								<div class="inputR">
									<div class="inputC">
										<input name="apa709" class="mini-combobox" required="true"
											emptyText="请选择..." textField="text" data="${dic['APA709']}"
											valueField="id" />
					...
					<tr>
						...
						<td>
							<div class="inputL" style="width: 130px">
								<div class="inputR">
									<div class="inputC">
										<input name="aae011" enabled="false" class="mini-textbox"
											readonly="readonly" />
							...
							<div style="padding-left:435px; ">
								<span class="btnMini"> 
									<em> <input type="button"
											value="提交" onclick="SaveData();"/> 
									</em> 
								</span>
								<span class="btnMini"> 
									<em> <input type="button"
											value="关闭" onclick="closeWin();"/> 
											</em>
								 </span>
							 </div>
						</td>
	...
	function SetData() {
		$
				.ajax( {
					url : "${pageContext.request.contextPath}/k4/f10402002/initRuleData.action",
					type : "post",
	...
	function SaveData() {
		...
		$
				.ajax( {
					url : "${pageContext.request.contextPath}/k4/f10402002/saveRule.action",
					type : "post",
					data : {
						submitData : json
					},
