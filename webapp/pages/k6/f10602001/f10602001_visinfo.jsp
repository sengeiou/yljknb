		...
		<fieldset style="width: 100%; border: solid 0px #aaa;">
			<div id="editForm1" class="cxTabbox">
				<form id="form1" action="#">
					<input id="aaz263" name="aaz263" class="mini-hidden" required="true"/>
				...
				<div title="就诊信息" id="tab1" name="tab1">
					<div class="mainlistCon">
						...
						<div id="grid1" class="mini-datagrid" idField="id"   onrowclick="queryDetail" 
							...
							url="${pageContext.request.contextPath}/k6/f10602001/loadDoctVisit.action">
					...
					<div class="mainlistCon">
						...
						<div id="grid2" class="mini-datagrid" idField="id" multiSelect="true"
	             			...
	             			url="${pageContext.request.contextPath}/k6/f10602001/loadDoctPres.action">
	             			<div property="columns">
	             				<div type="indexcolumn"></div>
					...
					<div class="mainlistCon">
						...
						<div id="grid3" class="mini-datagrid" idField=" idmultiSelect="false" 
							style="width: 100%; height:360px;" allowResize="true"
						 	url="${pageContext.request.contextPath}/k6/f10602001/loadDoctViola.action">
						 	<div property="columns">
						 		<div type="indexcolumn"></div>
		...
		<script type="text/javascript">
			...
			//标准方法接口定义
     		function setData(data){
     			...
     			mini.get("aaz263").setValue(data.aaz263);
