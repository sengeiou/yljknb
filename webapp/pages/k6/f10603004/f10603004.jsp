	...
	<body>
							...
							<tr>
								...
								<td>
									<div class="inputL" style="width:130px">
										<div class="inputR">
											<div class="inputC">
												<input id="midrug" name="midrug" class="mini-combobox" emptyText="请选择..." 
													value="AKC264"
													data="${dic['MIDRUG']}" textField="text" valueField="id" required="true"/>
											</div>
										</div>
									</div>
								</td>
							...
							<tr>
								...
								<td>
									<div class="inputL" style="width:130px">
										<div class="inputR">
											<div class="inputC">
												<input id="aka063" name="aka063" class="mini-combobox" emptyText="请选择..." 
													data="${dic['AKA063']}" textField="text" valueField="id" required="true"/>
											</div>
										</div>
									</div>
								</td> --%>
		...
		<fieldset>
			<div style="width: 100%; height: 250px;">
				<div size="35%" showCollapseButton="false" class="listTit">
					...
					<div id="mediDrugExpen" style="width: 100%; height: 210px;">
		...
		<fieldset>
			<div showCollapseButton="false" class="listTit">
				...
				<div id="tab1" name="tab1" class="mini-tabs" activeIndex="0" style="width: 100%;"plain="false">
					<div title="甲类" name="">
						<div id="grid1" class="mini-datagrid" idField="" multiSelect="false"
							...
							url="${pageContext.request.contextPath}/k6/f10603004/loadMediDrugDisease.action">
					...
					<div title="乙类" name="">
						<div id="grid2" class="mini-datagrid" idField="" multiSelect="false"
							...
							url="${pageContext.request.contextPath}/k6/f10603004/loadMediDrugMedical.action">
							<div property="columns">
								<div type="indexcolumn"></div>
								<div field="aaz107" width="100" headerAlign="center" align="center">医疗机构编号</div>
								<div field="aae041" width="100" headerAlign="center" align="center">就诊年月</div>
								<div field="akc021" width="140" headerAlign="center" align="center" type="comboboxcolumn">
									身份类别<input property="editor" class="mini-combobox" style="width:100%" data="${dic['AKC021']}">
								</div>
								<div field="aka130" width="140" headerAlign="center" align="center" type="comboboxcolumn">
									就诊类别<input property="editor" class="mini-combobox" style="width:100%" data="${dic['AKA130']}">
								</div>
								<div field="aka063" width="140" headerAlign="center" align="center" type="comboboxcolumn">
									发票项目类别<input property="editor" class="mini-combobox" style="width:100%" data="${dic['AKA063']}">
								</div>
								<div field="ake106" width="140" headerAlign="center" align="center" allowSort="true">用量</div>
								<div field="ake098" width="140" headerAlign="center" align="center" allowSort="true">接诊人次</div>
								<div field="akc264" width="140" headerAlign="center" align="center" allowSort="true">总费用</div>
								<div field="cjfy" width="140" headerAlign="center" align="center" allowSort="true">次均费用</div>
							</div>
						</div>
					</div>
					<div title="丙类" name="">
						<div id="grid3" class="mini-datagrid" idField="" multiSelect="false"
							...
							url="${pageContext.request.contextPath}/k6/f10603004/loadMediDrugIdentify.action">
							<div property="columns">
								<div type="indexcolumn"></div>
								<div field="aaz107" width="100" headerAlign="center" align="center">医疗机构编号</div>
								<div field="aae041" width="100" headerAlign="center" align="center">就诊年月</div>
		...
		<script type="text/javascript">
			...
			function search(){
				...
				var url = "${pageContext.request.contextPath}/k6/f10603004/loadMediDrugColumn.action";
				getChartData(url, json, function(datas) {
					showBarChartAnal('mediDrugExpen','', datas ,'','');
				});
			}
			
			var titleB=null;//分析内容
			function changeApeAndTitle(){
				var midrug = mini.get("midrug").getValue();
				var rank = mini.get("rank").getValue();
				if(midrug == "AKC264"){
					titleB = "总费用";
				}else if(midrug == "AKE106"){
					titleB = "用量";
				}else if(midrug == "CJFY"){
					titleB = "次均药品费";
				}
			...
			function resetForm(){
				...
				mini.get("midrug").setValue("AKC264");
