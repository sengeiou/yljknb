		...
		<fieldset style="width: 100%; border: solid 0px #aaa;">
			<div id="editForm1" class="cxTabbox">
				<form id="form1" action="#">
					<input id="aaz107" name="aaz107" class="mini-hidden" required="true"/>
				...
				<div title="就诊信息" id="tab1" name="tab1">
					<div class="mainlistCon">
						...
						<div id="grid1" class="mini-datagrid" idField="id" 
							...
							url="${pageContext.request.contextPath}/k6/f10603004/loadMediDrugVisist.action">
					...
					<div class="mainlistCon">
						...
						<div id="grid2" class="mini-datagrid" idField="id" multiSelect="true"
	             			...
	             			url="${pageContext.request.contextPath}/k6/f10603004/loadMediDrugPres.action">
	             			<div property="columns">
	             				<div type="indexcolumn"></div>
					...
					<div class="mainlistCon">
						...
						<div id="grid3" class="mini-datagrid" idField=" idmultiSelect="false" 
							style="width: 100%; height:360px;" allowResize="true"
						 	url="${pageContext.request.contextPath}/k6/f10603004/loadMediDrugViolate.action">
						 	<div property="columns">
						 		<div type="indexcolumn"></div>
