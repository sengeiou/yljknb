...
<body>
						...
						<div id="sp2" class="mini-splitter"
							...
							<div size="50%" showCollapseButton="false">
								...
								<div id="datagrid1" class="mini-datagrid"
									...
									url="${pageContext.request.contextPath}/k5/f10506002/indexAction.action">
							...
							<div size="50%" showCollapseButton="false">
								<div id="toolbar1" class="mini-toolbar" style="height: 10%;">
									<span class="btnMini" style="margin:0px 0px 2px 8px;"><em><input
											type="button" value="复议申请审核通过" onclick="preCheck('2','1');" />
									</em> </span> <span class="btnMini" style="margin:0px 20px 2px 20px;"><em><input
											type="button" value="复议申请审核驳回" onclick="preCheck('2','4');" />
									</em> </span>
								</div>
								<!--menu-->
								<div id="datagrid2" class="mini-datagrid" style="height: 86%;"
									...
									showSummaryRow="true"
									url="${pageContext.request.contextPath}/k5/f10506002/indexInfoAction.action">
									<div property="columns">
										<div type="checkcolumn"></div>
	...
	<script type="text/javascript">
		...
		function onShowRowDetail1(e) {
			...
			$
					.ajax({
						url : "${pageContext.request.contextPath}/k5/f10506002/indexDetailAction.action",
						type : "post",
						data : {
							baz001 : row.baz001
						},
		...
		function onShowRowDetail2(e) {
			...
			$
					.ajax({
						url : "${pageContext.request.contextPath}/k5/f10506002/indexInfoDetailAction.action",
						type : "post",
						data : {
							baz001 : row.baz001,
							baz003 : row.baz003
						...
						success : function(text) {
							if (text.success) {
								...
								htmlStr += "<tr><td></td><td colspan='2'><span class='btnMini' style='margin:0 10px'><em><input type='button' onclick=preCheck('1','1') value='复议待审核' /></em></span><span class='btnMini' style='margin:0 10px'><em><input type='button' onclick=preCheck('1','4') value='待医师复议申请' /></em></span></td><td></td></tr>";
								htmlStr += "</table>";
								htmlStr += "</div>";
		...
		function preCheck(tag, bazValue) {
			...
			if ("2" == tag) {
				mini
						.open({
							url : "${pageContext.request.contextPath}/pages/k5/f10506002/f10506002_info.jsp",
							title : '复议申请审核',
							width : 350,
							height : 200,
							onload : function() {
		...
		function queryNumber() {
			...
			if (akb020orakb021 != "") {
				akb020 = akb020orakb021;
			}
			$
					.ajax({
						url : "${pageContext.request.contextPath}/k5/f10506002/queryNumber.action",
						type : "post",
						data : {
							akb020 : akb020
						},
						success : function(text) {
							if (text.success) {
								...
								for ( var i = 0; i < text.result.length; i++) {
									...
									htmlStr += "<td style='padding-bottom:6px;'>待医保办审核数：</td>";
									...
									htmlStr += "<td style='padding-bottom:6px;'><div class='td_number'>"
											+ text.result[i].dssshs//待医保办审核
											+ "</div>	</td>";
									htmlStr += "<td style='padding-bottom:6px;'><div class='td_number'>"
											+ text.result[i].cqs//超期数
											+ "</div>	</td>";
									htmlStr += "</tr>";
									...
									htmlStr += "<td></td>";
									htmlStr += "<td style='padding-bottom:6px;'>超期数：	<div class='td_number2'>"
											+ text.result[i].cqs
											+ "</div>	</td>";
									htmlStr += "</tr>"; */
