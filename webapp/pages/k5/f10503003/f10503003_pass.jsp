...
<body>
	...
	<script type="text/javascript">
		...
		function SetData(data){
		     	...
		     	$.ajax({
		     		url:"${pageContext.request.contextPath}/k5/f10503003/toBreAuditPass.action?method=toBreAuditPass",
		     		type:"post",
		...
		function SaveData() {
			...
			$.ajax({
				url: "${pageContext.request.contextPath}/k5/f10503003/breAuditPass.action?method=breAuditPass",
				type: "post",
