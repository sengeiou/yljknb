						...
						<div id="sp2" class="mini-splitter"
							...
							<div size="50%" showCollapseButton="false">
								...
								<div id="datagrid1" class="mini-datagrid"
									...
									url="${pageContext.request.contextPath}/k5/f10504002/indexAction.action">
							...
							<div size="50%" showCollapseButton="false">
								<div id="toolbar1" class="mini-toolbar" style="height: 10%;">
									<span class="btnMini" style="margin:0px 0px 2px 8px;"><em><input
											type="button" value="审核通过" onclick="preCheck('2','03');" />
									</em>
									</span> <span class="btnMini" style="margin:0px 20px 2px 20px;"><em><input
											type="button" value="驳回" onclick="preCheck('2','2');" />
									</em>
									</span>
								</div>
								<!--menu-->
								<div id="datagrid2" class="mini-datagrid" style="height: 86%;"
									...
									pageSize="20" onshowrowdetail="onShowRowDetail2" onrowclick=""
									onrowdblclick="queryHistory" showSummaryRow="true"
									showColumnsMenu="true" sortMode="client"
									url="${pageContext.request.contextPath}/k5/f10504002/indexInfoAction.action">
									<div property="columns">
										<div type="checkcolumn"></div>
										<div field="baz031" type="comboboxcolumn" width="100"
											allowSort="true" visible="false" headerAlign="center">
											审核状态 <input property="editor" class="mini-combobox"
												style="width: 100%" data="${dic['BAZ031']}">
										</div>
	...
	<script type="text/javascript">
		...
		function preCheck(tag, bazValue) {
			...
			if ("2" == tag) {
				mini
						.open({
							url : "${pageContext.request.contextPath}/pages/k5/f10504002/f10504002_info.jsp",
							title : '待申诉',
							width : 350,
							height : 200,
							onload : function() {
				...
				$
						.ajax({
							url : "${pageContext.request.contextPath}/k5/f10504002/indexComplaintUpdateAction.action",
							type : "post",
							data : {
								submitData : ids,
								tag : tag
		...
		function queryNumber() {
			...
			$
					.ajax({
						url : "${pageContext.request.contextPath}/k5/f10504001/queryNumber.action",
						type : "post",
						data : {
							...
							if (text.success) {
								...
								for ( var i = 0; i < text.result.length; i++) {
									...
									htmlStr += "<td style='padding-bottom:6px;'><div class='td_number'>"
											...
											+ "</div>	</td>";
									//	htmlStr+="<td style='padding-bottom:6px;'><div class='td_number'>"+text.result[i].cqs+"</div>	</td>";
									htmlStr += "</tr>";
					...
					function(data) {
						if (data.success) {
							...
							for ( var i = 0; i < data.result.length; i++) {
								...
								htmlStr += "<table cellpadding=\"0\" class=\"cxTab\" cellspacing=\"0\" border=\"0\" width=\"100%\">";
								htmlStr += "<tr><td style=\"padding-bottom:6px;\">待申述审核数：</td></tr>";
