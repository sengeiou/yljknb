...
<body style="background-color:#F3F3F3 ;">
		...
		<div style="text-align:center; margin:10px;">
			<form id="form" action="#">
				<table cellpadding="0" class="cxTab" cellspacing="0" border="0"
					...
					<tr>
						<td>审核意见：</td>
						<td colspan="4"><input id="cyyj" style="width:40px;" showClose="true"
								popupWidth="150" name="cyyj"  textField="text" class="mini-combobox" data="cyyj"
								multiSelect="true" oncloseclick="onCloseClick" onvaluechanged="onValueChanged">
					...
					<tr>
						<td nowrap="nowrap" colspan="5"
							...
							class="btnMini"><em><input type="button"
									onclick="preCheck()" value="确定" /> </em> </span> <span class="btnMini"><em><input
	...
	<script type="text/javascript">
		...
		function preCheck() {
			...
			$
					.ajax({
						url : "${pageContext.request.contextPath}/k2/f10203001/medDocumentDetailOperate.action",
						type : "post",
						data : {
							submitData : json
						},
