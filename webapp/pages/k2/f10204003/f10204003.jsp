...
<body>
	<div class="mainlistCon">
		<div id="layout1" class="mini-layout nobor" allowResize="false"
						...
						<div id="sp2" class="mini-splitter"
							...
							<div size="50%" showCollapseButton="false">
								...
								<div id="datagrid1" class="mini-datagrid"
									...
									url="${pageContext.request.contextPath}/k2/f10204003/queryMedDocument.action">
							...
							<div size="50%" showCollapseButton="false">
								...
								<div id="datagrid2" class="mini-datagrid" style="height: 86%;"
									...
									showColumnsMenu="true"
									url="${pageContext.request.contextPath}/k2/f10204003/queryMedDocumentDetail.action">
									<div property="columns">
										<div type="checkcolumn"></div>
										<div type="expandcolumn">~</div>
										<div field="baz031" type="comboboxcolumn" width="100"
			...
			<div title="east" region="east" width="350" expanded="false"
	...
	<script type="text/javascript">
						...
						success : function(text) {
							if (text.success) {
								...
								for ( var i = 0; i < text.result[0].kc72List.length; i++) {
									htmlStr += "<tr><td style='width:100px'>违规描述：</td><td colspan='3' style='width:500px'>"+text.result[0].kc72List[i].aaa167+"："+text.result[0].kc72List[i].aaa133+"</td></tr>";
								}
		...
		/* 医院汇总 */
		function searchWithHospital() {

			var akb020orakb021 = mini.get("akb020orakb021").getValue();
			//alert(akb020orakb021);
			$
					.ajax({
						url : "${pageContext.request.contextPath}/k2/f10204003/searchWithHospital.action",
						type : "post",
						data : {
						...
						success : function(text) {
							...
							if (text.success) {
								...
								for ( var i = 0; i < text.result.length; i++) {
									...
									/*  htmlStr += "<td style='padding-bottom:6px;'>待复议处理数：</td>"; */
									htmlStr += "<td style='padding-bottom:6px;'>待复议审核数：</td>";
									...
									/* htmlStr += "<td style='padding-bottom:6px;'><div class='td_number'>"
											+ text.result[i].dfycls
											+ "</div>	</td>"; */
									htmlStr += "<td style='padding-bottom:6px;'><div class='td_number'>"
											+ text.result[i].dfyshs
											+ "</div>	</td>";
