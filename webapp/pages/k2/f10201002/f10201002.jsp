...
<html xmlns="http://www.w3.org/1999/xhtml">
					...
					<table class="cxTab" cellpadding="0" cellspacing="0" border="0"
						...
						<tr>
									...
									<div class="inputR">
										<div class="inputC">
											<input id="baz021" name="baz021" class="mini-combobox"
												emptyText="选择智能审核结果..." data="${dic['BAZ021']}" />
										</div>
									</div>
								</div>
							</td>
							...
							<td>
								<div class="inputL" style="width: 130px">
									<div class="inputR">
										<div class="inputC">
											<input id="zsd" name="zsdmc" class="mini-textbox" />
										</div>
									</div>
								</div>
							</td>
						...
						<tr>
							...
							<td style="text-align: center; padding-top: 5px; padding-left: 55px;" colspan="2">
								...
								<input type="button" value="" class="cxreset" onclick="resetFrom();" />
							</td>
						</tr>
					</table>
				</form>
		...
		<div class="mainlistCon">
			<div class="listTit">
				...
				<div class="fR pT5R9">
					...
					<span class="btnMini"><em><input type="button" value="送复审"/></em></span>
				</div>
			</div>
			...
			<div id="datagrid1" class="mini-datagrid"
				...
				url="${pageContext.request.contextPath}/k2/f10201002/queryMedDocument.action">
				<div property="columns">
					<div type="checkcolumn"></div>
					<div type="expandcolumn">~</div>
					<div type="reportcolumn" width="80" renderer="onReportRenderer">报告</div>
					...
					<div field="akb022" type="comboboxcolumn" width="100" headerAlign="center">
						机构类型<input property="editor" class="mini-combobox" style="width:100%" data="${dic['AKB022']}">
					</div>
					...
					<div field="aka130" width="100" headerAlign="center" type="comboboxcolumn">
						就诊类别<input property="editor" class="mini-combobox" style="width:100%" data="${dic['AKA130']}">
					</div>
					<div field="akc194" width="100" dateFormat="yyyyMMdd" headerAlign="center">
						就诊结算时间
					</div>
					...
					<div id="detail_tabs" class="mini-tabs" activeIndex="0"
						...
						<div title="费用明细">
							<div id="datagrid2" class="mini-datagrid" style="height: 100%;"
								...
								pageSize="20" onshowrowdetail="onShowRowDetail2" onrowclick="queryCheckRecord" 
								url="${pageContext.request.contextPath}/k2/f10201002/queryMedDocumentDetail.action">
								<div property="columns">
									<div type="checkcolumn"></div>
									<div type="expandcolumn">~</div>
									<div field="baz031" type="comboboxcolumn" width="100" headerAlign="center">
									...
									<div field="baz033" type="comboboxcolumn" width="100" headerAlign="center">
										违规类型<input property="editor" class="mini-combobox" style="width:100%" data="${dic['BAZ033']}">
									</div>
									...
									<table cellpadding="0" class="cxTab" cellspacing="0" border="0"
										...
										<tr>
											<td nowrap="nowrap" colspan="5" style="text-align: center; padding-top: 5px;">
												<span class="btnMini"><em><input type="button" onclick="preCheck('01')" value="正常"/></em></span>
												<span class="btnMini"><em><input type="button" onclick="preCheck('05')" value="送核查"/></em></span>
												<span class="btnMini"><em><input type="button" onclick="preCheck('07')" value="送复审"/></em></span>
												<span class="btnMini"><em><input type="button" onclick="preCheck('09')" value="直接扣款"/></em></span>
											</td>
										</tr>
									</table>
								</form>
						...
						<div title="审核日志">
						    <div id="checkRecord" class="auditBox mini-datagrid" style="height: 100%;" showColumns="false" showPager="false" 
								...
								<div property="columns">
									...
									<div field="baz022" headerAlign="center">
										审核人
									</div>
									<div field="baz023Str" dataType="date" dateFormat="yyyy-MM-dd"  headerAlign="center">
										审核时间
									</div>
								</div>
							</div>
    ...
    function preCheck(baz031){
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/k2/f10201002/medDocumentDetailOperate.action",
            type: "post",
    ...
    function onReportRenderer(e){
    	...
    	var str = "<a href='javascript:void(0)' title='参保人' onclick = viewPerson('" + record.aac001 + "')><img src='../../images/cbr.png'/></a> ";
    	str += "<a href='javascript:void(0)' title='医院' onclick = viewHospital('" + akb020 + "')><img src='../../images/ddjg.png'/></a> ";
    	str += "<a href='javascript:void(0)' title='医师' onclick = viewDoctor('" + record.aaz263 + "')><img src='../../images/ys.png'/></a> ";
        return str;
    }
	function resetFrom() {
		queryForm.reset();
