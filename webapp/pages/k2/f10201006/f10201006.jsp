...
<body>
						...
						<div id="sp2" class="mini-splitter"
							...
							<div size="50%" showCollapseButton="false">
									...
									<table style="width:100%;">
										<tr>
											<td style="width:100%;"><a class="mini-menubutton"
												plain="true" menu="#popupMenu">所选明细</a></td>
										</tr>
									</table>
								</div>
								<!--menu-->
								<ul id="popupMenu" class="mini-menu" style="display:none;">
									<li onclick="plcl('扣除全部');">扣除全部</li>
									<li onclick="plcl('扣除定额');">扣除定额</li>
									<li onclick="plcl('不违规');">不违规</li>
									<li onclick="plcl('送核查');">送核查</li>
								</ul>
								<div id="datagrid2" class="mini-datagrid" style="height: 86%;"
									...
									showColumnsMenu="true"
									url="${pageContext.request.contextPath}/k2/f10201006/queryMedDocumentDetail.action">
									<div property="columns">
										<div type="checkcolumn"></div>
										<div type="expandcolumn">~</div>
										<div field="baz031" type="comboboxcolumn" width="100"
										...
										<div field="ack221" width="100" dateFormat="yyyyMMdd"
	...
	<script type="text/javascript">
					...
					.ajax({
						...
						success : function(text) {
							if (text.success) {
								...
								htmlStr += "<tr><td style='width:100px'>诊断：</td><td colspan='3' style='width:500px'>急性肠胃炎</td></tr>";
								...
								htmlStr += "<tr><td style='width:100px'>审核意见：</td><td colspan='3' style='width:500px'><textarea  name='baz021'  class='mini-textarea' style='width:400px' ></textarea></td></tr>";
								htmlStr += "<tr><td>扣除金额：</td><td colspan='3'><input name='je'  type='text'  /></td></tr>";
								htmlStr += "<tr><td></td></tr>";
								htmlStr += "<tr><td></td><td colspan='2'><span class='btnMini' style='margin:0 10px'><em><input type='button' onclick='preCheck('01')' value='扣款' /></em></span><span class='btnMini' style='margin:0 10px'><em><input type='button' onclick='preCheck('01')' value='不违规' /></em></span><span class='btnMini' style='margin:0 10px'><em><input type='button' onclick='preCheck('01')' value='送核查' /></em></span></td><td></td></tr>";
								
								htmlStr += "</table>";
								htmlStr += "</div>";
								//htmlStr += "<span style='vertical-align: middle;'>审核意见：</span><textarea  name='baz021'  class='mini-textarea' stle='wei' ></textarea>";
								//htmlStr += "<div style='padding:6px 10px 6px 62px;'>";
								//htmlStr += "<span class='btnMini'><em><input type='button' onclick='preCheck('01')' value='扣款' /></em></span>";
								//htmlStr += "<span class='btnMini'><em><input type='button' onclick='preCheck('01')' value='不违规' /></em></span>";
								//htmlStr += "<span class='btnMini'><em><input type='button' onclick='preCheck('01')' value='送核查' /></em></span>";
								//htmlStr += "</div>";
		...
		function queryHistory(e) {
			...
			mini
					.open({
						url : "${pageContext.request.contextPath}/pages/k2/f10201006/f10201006_sjz.jsp",
						title : "审核历史",
						width : 550,
						height : 300,
						onload : function() {
